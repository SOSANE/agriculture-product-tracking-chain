...
import { CheckCircle, MapPin, Clock, Thermometer, Truck, Factory, Home, ShoppingBag, Sprout, Trees, Flower, Package2, Scan } from 'lucide-react';
                            ...
                            {step.certificates && step.certificates.length > 0 && (
                                <div className="mt-2 flex flex-wrap gap-1">
                                    {step.certificates.map((cert) => (
                                        <span key={cert.id} className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-primary bg-opacity-10 text-primary">
