      ...
      <div className="container mx-auto px-4 py-12">
        <header className="text-center text-white mb-16">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto">
            Track and verify agricultural products from farm to table using
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8 p-8 items-center">
            <div className="text-center md:text-left flex flex-col h-full">
              <div className="flex-grow">
                ...
                <p className="text-neutral-600 mb-8">
                  Scan any product's QR code to instantly verify its
            ...
            <div className="border-t md:border-l md:border-t-0 border-neutral-200 pt-8 md:pt-0 md:pl-8 flex flex-col h-full">
              <div className="flex-grow">
                <h2 className="text-2xl font-semibold mb-4">
                  Stakeholder Login
                </h2>
