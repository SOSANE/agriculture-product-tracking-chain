    ...
    try {
      if (qrData) {
        ...
        if (contractAddress === import.meta.env.VITE_CONTRACT_ADDRESS) {
          ...
          if (!response?.id) {
            setError(
              "No product found with this ID. Please check and try again.",
            );
        ...
        <div className="max-w-3xl mx-auto">
          <header className="text-center mb-10">
            ...
            <p className="text-neutral-600 max-w-xl mx-auto">
              Scan a product QR code or enter a product ID to verify its
              authenticity and view its journey through the supply chain.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-neutral-600 max-w-xs mx-auto">
                    Use your camera to scan the product QR code for instant
                    verification
                  </p>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-neutral-600 mb-6 text-center md:text-left">
                  Enter the product ID or batch number found on the product
                  packaging
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  Confirm your product is genuine and not counterfeit by
                  verifying its blockchain record.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  See the complete journey of your product from farm to shelf,
                  including all handling and processing steps.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  Check all certifications and compliance records to ensure your
