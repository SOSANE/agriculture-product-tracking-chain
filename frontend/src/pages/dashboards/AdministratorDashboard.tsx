  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 py-8">
        <Header
          user={user}
          altHeader="Administrator Dashboard"
          text="Manage products or accounts as an administrator"
          altText="Manage products or accounts"
        />
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          <div
            className="card lg:col-span-2 overflow-x-auto pb-6"
            style={{ maxHeight: "398px" }}
          >
